...
const defaults = {
  ...
  // Drop item sends addressed to a slot that has already goaled or released. Late in an async
  // most of the remaining traffic is items nobody will collect. Goal status is read from the
